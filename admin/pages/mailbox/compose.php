      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="../tables/donation.php" class="nav-link">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Recipient name" id="name">
                </div>
                <div class="form-group">
                  <input type="email" class="form-control" placeholder="To:example@gmail.com" id="email">
                </div>
                <div class="form-group">
              ...
              <div class="card-footer">
                <div class="float-right">
                  ...
                  <button type="submit" class="btn btn-primary" id="sendmail"><i class="far fa-envelope"></i> Send</button>
                </div>
