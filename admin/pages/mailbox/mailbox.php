                  ...
                  <tbody>
                    ...
                    ?>
                        <a href="" ><tr>
                          ...
                          <td class="mailbox-name"><a href="#" id="mail-<?= $inbox['id']?>" onclick="change(this.id);">Alexander Pierce</a></td>
                          <td class="mailbox-subject">
                            <?php
                              if($inbox['is_read'] == 0):
                            ?>
                              <b>AdminLTE 3.0 Issue - Trying to find a solution to this problem...</b>
                            <?php else: ?>
